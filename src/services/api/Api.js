...
class Api extends baseApi {
    ...
    register = new Endpoint({endpoint: "auth/register", method:"POST", reducer: "user", prepareRequest: prepareRegisterRequest})
    login = new Endpoint({endpoint: "auth/login", method: "POST", reducer: "user"})
